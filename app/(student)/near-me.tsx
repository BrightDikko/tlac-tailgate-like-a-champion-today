...
import { AppHeader, Card, Screen, SectionHeader, TailgateCard } from '@/src/components';
...
export default function NearMeTabScreen() {
  const sorted = [...tailgates].sort((a, b) => distanceValue(a.distance) - distanceValue(b.distance));
          ...
          <View style={styles.mapHeader}>
            ...
            <View style={styles.mapHeaderText}>
              ...
              <Text style={styles.mapBody}>
                You are browsing the gameday footprint around {currentGame.location}. Distances are
